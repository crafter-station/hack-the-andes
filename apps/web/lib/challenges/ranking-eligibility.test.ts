...
describe("challenge ranking eligibility", () => {
  ...
  test("ranks one eligible account per person only above 50 percent", async () => {
    const scores = [0.9, 0.8, 0.7, 0.6, 1, 0.5, 0.51];
    ...
    await client.query(
      `insert into applications (
        ...
        (gen_random_uuid(), $1, 'submitted', 'https://github.com/same-person', 'https://linkedin.com/in/first-profile', '2026-09-18T12:00:00Z'),
        ...
        (gen_random_uuid(), $4, 'submitted', 'https://github.com/same-person/', 'https://linkedin.com/in/later-profile', '2026-09-22T12:00:00Z'),
