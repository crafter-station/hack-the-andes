...
export interface BadgeReadyEmailInput {
  ...
  /** Present only for the default badge generated by an acceptance decision. */
...
export const buildBadgeReadyEmail = (
  ...
  if (input.notification?.kind === "acceptance") {
    return buildDecisionEmail({
      decision: "accepted",
      firstName: input.firstName,
      message: input.notification.message,
      badgeUrl: input.badgeUrl,
      badgePageUrl: input.badgePageUrl,
